...
client.on('guildMemberAdd', guildMember =>{
    ...
    if(guildMember.guild.roles.cache.find(role => role.name === 'Member')) {
    	guildMember.roles.add(welcomeRole);
}
    
    if(guildMember.guild.channels.cache.find(channel => channel.name === 'welcome')) {
        wchannel.send(embed);
        }
});
...
client.on('guildMemberRemove', guildMember =>{
    ...
    if(guildMember.guild.channels.cache.find(channel => channel.name === 'leave')) {
        lchannel.send(embed);
        }
});
